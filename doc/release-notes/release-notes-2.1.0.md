EutoCoin Core version *2.1.0* is now available!!
==============

  <https://github.com/EutoCoinProject/EutoCoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/EutoCoinProject/EutoCoin/commits/release_2.1.0>
