...
This document provides guidelines for internationalization of the EutoCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `eutocoin_en.ts` remains unchanged.
