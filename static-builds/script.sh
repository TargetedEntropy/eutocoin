...
rm -rf ~/eutocoin ~/sign ~/release

git clone https://github.com/foxdproject/eutocoin.git
cd ~/eutocoin
chmod -R +x *
git checkout $BRANCH
...
find ${DISTNAME}/bin -type f -executable -exec ../eutocoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../eutocoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/eutocoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/eutocoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
