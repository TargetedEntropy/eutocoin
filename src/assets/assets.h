...
#ifndef EUTOCOIN_ASSET_PROTOCOL_H
#define EUTOCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_EUTOCOIN_ASSET EUTOQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_EUTOCOIN_ASSET EUTOO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_EUTOCOIN_ASSET EUTOR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_EUTOCOIN_ASSET EUTOT
...
#endif //EUTOCOIN_ASSET_PROTOCOL_H
