...
#ifndef EUTOCOIN_WALLET_WALLET_H
#define EUTOCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this eutocoin node, and set to 0 for transactions that were created
...
public:
    ...
    void AvailableCoinsAll(std::vector<COutput>& vCoins, std::map<std::string, std::vector<COutput> >& mapAssetCoins,
                            bool fGetEUTO = true, bool fOnlyAssets = false,
    ...
    /**
     * Helper function that calls AvailableCoinsAll, used to receive all coins, Assets and EUTO
     */
...
#endif // EUTOCOIN_WALLET_WALLET_H
