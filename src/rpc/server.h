...
#ifndef EUTOCOIN_RPCSERVER_H
#define EUTOCOIN_RPCSERVER_H
...
/**
 * EutoCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isEUTO = true);
