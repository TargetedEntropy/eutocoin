...
#ifndef EUTOCOIN_QT_GUIUTIL_H
#define EUTOCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the EutoCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "eutocoin:" URI into recipient object, return true on successful parsing
