...
#include "qt/eutocoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<EutoCoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_eutocoin-qt -platform xcb      # Linux
//     src/qt/test/test_eutocoin-qt -platform windows  # Windows
//     src/qt/test/test_eutocoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = EutoCoinUnits::formatWithUnit(unit, balance, false, EutoCoinUnits::separatorAlways);
    ...
    // Amount input
    EutoCoinAmountField* amountInput = receiveCoinsDialog.findChild<EutoCoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: eutocoin:")) != -1);
