...
#ifndef EUTOCOIN_QT_EUTOCOINGUI_H
#define EUTOCOIN_QT_EUTOCOINGUI_H
...
/**
  EutoCoin GUI main class. This class represents the main window of the EutoCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class EutoCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit EutoCoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~EutoCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a eutocoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // EUTOCOIN_QT_EUTOCOINGUI_H
