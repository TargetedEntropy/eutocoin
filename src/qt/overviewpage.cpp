...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(EutoCoinUnits::EUTO),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(EutoCoinUnits::formatWithUnit(unit, balance, false, EutoCoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(EutoCoinUnits::formatWithUnit(unit, unconfirmedBalance, false, EutoCoinUnits::separatorAlways));
    ui->labelImmature->setText(EutoCoinUnits::formatWithUnit(unit, immatureBalance, false, EutoCoinUnits::separatorAlways));
    ui->labelTotal->setText(EutoCoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, EutoCoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(EutoCoinUnits::formatWithUnit(unit, watchOnlyBalance, false, EutoCoinUnits::separatorAlways));
    ui->labelWatchPending->setText(EutoCoinUnits::formatWithUnit(unit, watchUnconfBalance, false, EutoCoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(EutoCoinUnits::formatWithUnit(unit, watchImmatureBalance, false, EutoCoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(EutoCoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, EutoCoinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("EUTO")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the EUTO balance grid from expanding and looking terrible when asset balance is hidden
