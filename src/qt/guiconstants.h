...
#ifndef EUTOCOIN_QT_GUICONSTANTS_H
#define EUTOCOIN_QT_GUICONSTANTS_H
...
/* EutoCoinGUI -- Size of icons in status bar */
...
/* EutoCoin dark orange */
#define COLOR_DARK_ORANGE QColor("#f05339")
/* EutoCoin light orange */
...
/* EutoCoin shadow color - light mode */
...
/* EutoCoin label color as a string */
...
#define QAPP_ORG_NAME "EutoCoin"
#define QAPP_ORG_DOMAIN "eutocoin.com"
#define QAPP_APP_NAME_DEFAULT "EutoCoin-Qt"
#define QAPP_APP_NAME_TESTNET "EutoCoin-Qt-testnet"

#endif // EUTOCOIN_QT_GUICONSTANTS_H
