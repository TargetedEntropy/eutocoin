...
#ifndef EUTOCOIN_QT_EUTOCOINUNITS_H
#define EUTOCOIN_QT_EUTOCOINUNITS_H
...
/** EutoCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EutoCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EutoCoinUnits(QObject *parent);

    /** EutoCoin units.
      @note Source: https://en.eutocoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        EUTO,
...
typedef EutoCoinUnits::Unit EutoCoinUnit;

#endif // EUTOCOIN_QT_EUTOCOINUNITS_H
