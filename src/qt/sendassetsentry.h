...
#ifndef EUTOCOIN_QT_SENDASSETSENTRY_H
#define EUTOCOIN_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending eutocoins.
...
#endif // EUTOCOIN_QT_SENDASSETSENTRY_H
