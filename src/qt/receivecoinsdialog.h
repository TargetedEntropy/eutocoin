...
#ifndef EUTOCOIN_QT_RECEIVECOINSDIALOG_H
#define EUTOCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of eutocoins */
...
#endif // EUTOCOIN_QT_RECEIVECOINSDIALOG_H
