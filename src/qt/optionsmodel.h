...
#ifndef EUTOCOIN_QT_OPTIONSMODEL_H
#define EUTOCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for EutoCoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // EutoCoinUnits::Unit
...
#endif // EUTOCOIN_QT_OPTIONSMODEL_H
