...
#ifndef EUTOCOIN_SCRIPT_STANDARD_H
#define EUTOCOIN_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_EUTOCOIN_ASSET script that carries data
    /** EUTO END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a eutocoin address
 */
...
/**
 * Generate a EutoCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // EUTOCOIN_SCRIPT_STANDARD_H
