...
#ifndef EUTOCOIN_SCRIPT_SCRIPT_H
#define EUTOCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, EutoCoin always counted CHECKMULTISIGs
...
#endif // EUTOCOIN_SCRIPT_SCRIPT_H
