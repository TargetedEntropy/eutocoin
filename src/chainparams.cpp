...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000000d6bda8649546d24348c2dc714533901b58dd1f24517e41be70e61b39cf"); // Block 1
        ...
        // Build Genesis Block:
        /*
        uint32_t nGenesisTime = 1691615175;
        arith_uint256 test;
        bool fNegative;
        bool fOverflow;
        ...
        */
        ...
        genesis = CreateGenesisBlock(1691615175, 17893354, 0x1e00ffff, 2, 1000000 * COIN);

        consensus.hashGenesisBlock = genesis.GetX16RHash();

        assert(consensus.hashGenesisBlock == uint256S("0x000000d6bda8649546d24348c2dc714533901b58dd1f24517e41be70e61b39cf"));
        assert(genesis.hashMerkleRoot == uint256S("6f092f185b2e997f6eedcf6c91479b0e7d392a4f38d39f48ef3a4d17772b634f"));

        
           vSeeds.emplace_back("107.152.44.205", false);
           vSeeds.emplace_back("107.152.39.241", false);
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the EutoCoin chain
...
//        /////////////////////////////////////////////////////////////////
       ...
       /* vSeeds.emplace_back("seed-testnet-eutocoin.bitactivate.com", false);
        vSeeds.emplace_back("seed-testnet-eutocoin.eutocoin.com", false);
        vSeeds.emplace_back("seed-testnet-eutocoin.eutocoin.org", false);
        */
