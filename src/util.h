 ...
 */
#ifndef EUTOCOIN_UTIL_H
#define EUTOCOIN_UTIL_H
...
extern const char *const EUTOCOIN_CONF_FILENAME;
extern const char *const EUTOCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("eutocoin-%s", name);
