...
#ifndef EUTOCOIN_TEST_SCRIPTNUM10_H
#define EUTOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from EutoCoin Core 0.10.0, for cross-comparison.
 */
public:
