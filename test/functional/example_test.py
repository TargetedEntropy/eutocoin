...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the EutoCoinTestFramework
    pass

class ExampleTest(EutoCoinTestFramework):
    # Each functional test is a subclass of the EutoCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        EutoCoinTestFramework class so other tests can use it."""
