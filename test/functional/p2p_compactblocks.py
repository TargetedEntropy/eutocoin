...
# TestNode: A peer we use to send messages to eutocoind, and store responses.
...
class CompactBlocksTest(EutoCoinTestFramework):
    ...
    # This test actually causes eutocoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that eutocoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for eutocoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # eutocoind will not send blocktxn responses for blocks whose height is
