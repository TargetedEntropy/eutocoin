...
By default, eutocoind will dump mempool on shutdown and
...
class MempoolPersistTest(EutoCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give eutocoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent eutocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
