...
class WalletTest(EutoCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 EUTO from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 EUTO with subtract fee from amount
        ...
        # Sendmany 10 EUTO with subtract fee from amount
