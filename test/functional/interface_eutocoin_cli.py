...
class TestEutoCoinCli(EutoCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `eutocoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `eutocoin-cli -getinfo` and the RPCs data is retrieved from.")
