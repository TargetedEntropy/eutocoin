...
class BIP66Test(EutoCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # eutocoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and eutocoind produces more specific reject
            # reasons.
