...
class AssetTest(EutoCoinTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("EUTOCOIN1", 1000)
        n0.issue("EUTOCOIN2", 1000)
        n0.issue("EUTOCOIN3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="EUTOCOIN*", verbose=False, count=2, start=-2)
        ...
        eutocoin_assets = n0.listassets(asset="EUTOCOIN*", verbose=False, count=2, start=-2)
        assert_equal(len(eutocoin_assets), 2)
        assert_equal(eutocoin_assets[0], "EUTOCOIN2")
        assert_equal(eutocoin_assets[1], "EUTOCOIN3")
        self.sync_all()
