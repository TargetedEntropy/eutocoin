...
class TxnMallTest(EutoCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 EUTO:
        ...
        # First: use raw transaction API to send 1240 EUTO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 EUTO coin each
        ...
        # Node0's balance should be starting balance, plus 50EUTO for another
        ...
        # Node0's total balance should be starting balance, plus 100EUTO for 
