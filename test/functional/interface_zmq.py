...
import os
import struct
from test_framework.test_framework import EutoCoinTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest (EutoCoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that eutocoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("eutocoind has not been built with zmq enabled.")
